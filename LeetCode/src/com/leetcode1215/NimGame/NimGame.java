package com.leetcode1215.NimGame;
...
public class NimGame {
	...
	// So in order to win, you have to ensure that you never reach the situation
	...
	// whether you pick one, two or three stones from the pile, your opponent can
	// pick three, two or one stone to ensure that, again, four stones will be left
	// to you on your turn.
	//
	// It is obvious that the same pattern repeats itself for
	// n=4,8,12,16,…n=4,8,12,16,…, basically all multiples of 44.
